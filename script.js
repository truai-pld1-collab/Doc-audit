...
// *** ฟังก์ชันใหม่: ลบข้อมูลแถวตาม Index (สำคัญ: ต้องใช้ Index ใน Google Sheet) ***
function deleteRow(rowIndex, sheetName) {
    ...
    fetch(url, {
        ...
        debouncedLoadData(); // โหลดข้อมูลใหม่หลังจากลบ
...
const scriptURL = "https://script.google.com/macros/s/AKfycbxDUaGtD8hL-vDqKY2RCZuZ6XAZtM6UwYFJrKp5Xr9c0lCtvNAWPtOLu-80xXF4BOVG/exec";
